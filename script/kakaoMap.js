document.querySelector("#shopList").addEventListener("click", (event) => {
  if (event.target.tagName === "LI") {
    document.querySelector("#keyword").value = "대구 " + event.target.textContent;
...
function addMarker(position, idx, title) {
  var imageSrc = "../img/marker_number.svg", // 마커 이미지 url, 스프라이트 이미지를 씁니다
...
function displayInfowindow(marker, title) {
  var content = '<div class="infoW" style="padding:5px;z-index:1;">' + title + "</div>";
